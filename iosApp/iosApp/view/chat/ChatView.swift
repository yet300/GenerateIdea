...
struct InputAreaView: View {
    ...
    var body: some View {
        HStack(spacing: 12) {
            ...
            TextField("Tell me your idea...", text: $inputText, axis: .vertical)
                .padding(12)
            ...
            Button(action: onSend) {
                Image(systemName: "arrow.up")
                    ...
                    .foregroundStyle(.white)
                    .padding(10)
                    .background(inputText.isEmpty || isLoading ? Color.gray.opacity(0.5) : Color.blue)
                    .clipShape(Circle())
            }
            .disabled(inputText.isEmpty || isLoading)
            .animation(.easeInOut, value: inputText.isEmpty || isLoading)
        }
        .padding(12)
